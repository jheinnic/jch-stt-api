...
// WITH g, gci_all, collect(gt_one) AS gt_one_all
// UNWIND gt_one_all AS gt_one
// WITH g, gci_all, gt_one
UNWIND gci_all AS gci_next
WITH g, gci_all, gt_one, gci_next {
    cmd_dip: CASE (gci_next.cmd_dip >= gt_one.cmd_dip) WHEN TRUE gci_next.cmd_dip ELSE gt_one.cmd_dip END,
    cmd_eng: CASE (gci_next.cmd_eng >= gt_one.cmd_eng) WHEN TRUE gci_next.cmd_eng ELSE gt_one.cmd_eng END,
    cmd_sec: CASE (gci_next.cmd_sec >= gt_one.cmd_sec) WHEN TRUE gci_next.cmd_sec ELSE gt_one.cmd_sec END,
    cmd_med: CASE (gci_next.cmd_med >= gt_one.cmd_med) WHEN TRUE gci_next.cmd_med ELSE gt_one.cmd_med END,
    cmd_sci: CASE (gci_next.cmd_sci >= gt_one.cmd_sci) WHEN TRUE gci_next.cmd_sci ELSE gt_one.cmd_sci END,
    dip_eng: CASE (gci_next.dip_eng >= gt_one.dip_eng) WHEN TRUE gci_next.dip_eng ELSE gt_one.dip_eng END,
    dip_sec: CASE (gci_next.dip_sec >= gt_one.dip_sec) WHEN TRUE gci_next.dip_sec ELSE gt_one.dip_sec END,
    dip_med: CASE (gci_next.dip_med >= gt_one.dip_med) WHEN TRUE gci_next.dip_med ELSE gt_one.dip_med END,
    dip_sci: CASE (gci_next.dip_sci >= gt_one.dip_sci) WHEN TRUE gci_next.dip_sci ELSE gt_one.dip_sci END,
    eng_sec: CASE (gci_next.eng_sec >= gt_one.eng_sec) WHEN TRUE gci_next.eng_sec ELSE gt_one.eng_sec END,
    eng_med: CASE (gci_next.eng_med >= gt_one.eng_med) WHEN TRUE gci_next.eng_med ELSE gt_one.eng_med END,
    eng_sci: CASE (gci_next.eng_sci >= gt_one.eng_sci) WHEN TRUE gci_next.eng_sci ELSE gt_one.eng_sci END,
    sec_med: CASE (gci_next.sec_med >= gt_one.sec_med) WHEN TRUE gci_next.sec_med ELSE gt_one.sec_med END,
    sec_sci: CASE (gci_next.sec_sci >= gt_one.sec_sci) WHEN TRUE gci_next.sec_sci ELSE gt_one.sec_sci END,
    med_sci: CASE (gci_next.med_sci >= gt_one.med_sci) WHEN TRUE gci_next.med_sci ELSE gt_one.med_sci END
} AS gci_seat_two
