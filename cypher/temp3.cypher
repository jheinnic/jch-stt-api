...
WITH g, gci_all, gci_seat_one, gci_seat_one { .* } AS team_one
WHERE none(gci_other IN gci_all WHERE // Prune all crew that score less than at least one other crew in all rounds.
		...
		(team_one.cmd_dip <= gci_other.cmd_dip) AND
		(team_one.cmd_eng <= gci_other.cmd_eng) AND
		(team_one.cmd_sec <= gci_other.cmd_sec) AND
		(team_one.cmd_med <= gci_other.cmd_med) AND
		(team_one.cmd_sci <= gci_other.cmd_sci) AND
		(team_one.dip_eng <= gci_other.dip_eng) AND
		(team_one.dip_sec <= gci_other.dip_sec) AND
		(team_one.dip_med <= gci_other.dip_med) AND
		(team_one.dip_sci <= gci_other.dip_sci) AND
		(team_one.eng_sec <= gci_other.eng_sec) AND
		(team_one.eng_med <= gci_other.eng_med) AND
		(team_one.eng_sci <= gci_other.eng_sci) AND
		(team_one.sec_med <= gci_other.sec_med) AND
		(team_one.sec_sci <= gci_other.sec_sci) AND
		(team_one.med_sci <= gci_other.med_sci)
)
